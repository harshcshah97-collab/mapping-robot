...
def regular_files(pattern):
    """Return only files so generated directories cannot break packaging."""
...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config'),
            regular_files('config/*.yaml')),
        (os.path.join('share', package_name, 'urdf'),
            regular_files('urdf/*.urdf')),
        (os.path.join('share', package_name, 'maps'),
            regular_files('maps/*')),
        (os.path.join('share', package_name, 'web_ui'),
            regular_files('web_ui/*')),
    ],
    install_requires=[
        'setuptools',
        'openai',
    ...
    description=(
        'ROS 2 companion robot mapping, navigation, and visual tracking'
    ),
    license='Apache-2.0',
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_package.person_follower_node:main',
            ...
            'my_robot_package.perception_benchmark:main',
        ],
    },
)
